...
let favoriteFoods = ['avocado', 'pizza', 'sourdough bread', 'classic cheesecake'];
...
favoriteFoods.unshift('tofu scramble');
console.log('Added a favorite food to beginning:', favoriteFoods[0]);
